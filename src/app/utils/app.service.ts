...
export class AppService {
  ...
  getDistrictList(obj: any) {
    return this.http.post(this.apiUrl + 'District/DistrictList', obj, {
      headers: this.headers,
    });
  }

  saveDistrict(obj: any) {
    return this.http.post(this.apiUrl + 'District/saveDistrict', obj, {
      headers: this.headers,
    });
  }

  deleteDistrict(obj: any) {
    return this.http.post(this.apiUrl + 'District/deleteDistrict', obj, {
      headers: this.headers,
    });
  }
  ...
  //Doctor
  saveDoctor(obj: any) {
    return this.http.post(this.apiUrl + 'Doctor/saveDoctor', obj, {
      headers: this.headers,
    });
  }
  ...
  saveCompany(obj: any) {
    return this.http.post(this.apiUrl + 'Company/saveCompany', obj, {
      headers: this.headers,
    });
  }

  deleteCompany(obj: any) {
    return this.http.post(this.apiUrl + 'Company/deleteCompany', obj, {
      headers: this.headers,
    });
  }
